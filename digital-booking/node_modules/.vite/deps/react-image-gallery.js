    ...
    !function(e, t) {
      ...
      return (() => {
        ...
        return (() => {
          ...
          var P = i(590), M = i.n(P), W = function() {
          ...
          }, z = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], N = "undefined" != typeof MutationObserver, j = function() {
            function e3() {
            ...
            return e3.prototype.addObserver = function(e4) {
              ...
              D && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), N ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, { attributes: true, childList: true, characterData: true, subtree: true })) : (document.addEventListener("DOMSubtreeModified", this.refresh), this.mutationEventsAdded_ = true), this.connected_ = true);
          ...
          var Le = function(e3) {
            ...
            return n3 = l2, (i2 = [{ key: "componentDidMount", value: function() {
              ...
              var n4 = this.props, i3 = n4.items, r3 = n4.lazyLoad, a2 = n4.slideDuration, s3 = n4.slideInterval, o3 = n4.startIndex, l3 = n4.thumbnailPosition, u2 = n4.showThumbnails, c2 = n4.useWindowKeyDown, h2 = this.state, d2 = h2.currentIndex, f2 = h2.isPlaying, p2 = e4.items.length !== i3.length, m2 = !M()(e4.items, i3), v2 = e4.startIndex !== o3, g2 = e4.thumbnailPosition !== l3, b2 = e4.showThumbnails !== u2;
              s3 === e4.slideInterval && a2 === e4.slideDuration || f2 && (this.pause(), this.play()), g2 && (this.removeResizeObserver(), this.initSlideWrapperResizeObserver(this.imageGallerySlideWrapper), this.initThumbnailWrapperResizeObserver(this.thumbnailsWrapper)), b2 && u2 && this.initThumbnailWrapperResizeObserver(this.thumbnailsWrapper), b2 && !u2 && this.removeThumbnailsResizeObserver(), (p2 || b2) && this.handleResize(), t3.currentIndex !== d2 && this.slideThumbnailBar(), e4.slideDuration !== a2 && (this.slideToIndex = L(this.unthrottledSlideToIndex, a2, { trailing: false })), !r3 || e4.lazyLoad && !m2 || (this.lazyLoaded = []), c2 !== e4.useWindowKeyDown && (c2 ? (this.imageGallery.current.removeEventListener("keydown", this.handleKeyDown), window.addEventListener("keydown", this.handleKeyDown)) : (window.removeEventListener("keydown", this.handleKeyDown), this.imageGallery.current.addEventListener("keydown", this.handleKeyDown))), (v2 || m2) && this.setState({ currentIndex: o3, slideStyle: { transition: "none" } });
